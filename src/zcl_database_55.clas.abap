...
* INSERTING A DB TABLE
  ...
  pop_tab = VALUE #(
    ( id = 1 name = 'French Fries' description = 'Thin Fried Potato' country = 'FR' last_change_at = t_stamp )
    ( id = 2 name = 'Bratwurst' description = 'Seasoned Sausage' country = 'DE' last_change_at = t_stamp )
    ( id = 3 name = 'Chicken Samosa' description = 'Chicken Filled Pastry' country = 'IN' last_change_at = t_stamp )
  ).
...
* MAPPING
  ...
  local_sm_tab = CORRESPONDING #( local_table MAPPING new_field = description ).
  out->write( local_sm_tab ).
